...
**Response**: Adlie are red, chinstrap are green, gentoo are blue
...
**Response**: Boxplot allows you to easily determine mean, median, and
variation, as well as outliers. Jitter plot gives you more specific
information, which would be useful for locating clumps of data.
...
**Response**: The md file is much easier to read and looks better than
the rmd. The rmd is essentially just a colored notepad.
...
**Response**: Jitter over box is much better. Data is hidden the other
way around.
...
**Response**: Having them mapped in the ggplot applies the aes to each
layer, as opposed to doing it in the geom and applying it to only that
layer
...
**Response**: Species seems to be contributing most to the peak at 46,
while the island seems to contribute to the one at 39.
...
**Response**: Positive linear relationship between the variables
...
**Response**: Gentoo generally have longer flippers and more mass, still
positive linear relationship even between species.
...
**Response**:It’s much easier to see overlapping data points.
